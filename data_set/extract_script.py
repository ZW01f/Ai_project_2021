#extract features given to the module 
import os
from subprocess import Popen, PIPE
from pandas import DataFrame

#function to change format of output "pdfid"
...
print("----Processing-----")	
filename = 'Python-cheat-sheet-April-2021.pdf' #input should be here
directory_malware = current_directory
command_to_execute = 'python3 pdfid.py ' + '"' + filename + '"'
stdout = Popen(command_to_execute, shell=True, stdout=PIPE).stdout
output = stdout.readlines()
dataset_a.append(getFeatures(output, ''))
dataset_p = DataFrame(dataset_a)
dataset_shuffled = dataset_p.sample(frac=1)
dataset_shuffled.to_csv('out.csv')
